...
public abstract class AbstractBaseAdapter2 {
    protected Properties adapterProperties;
    protected KafkaProducerOutput2 outputPort;


	public AbstractBaseAdapter2() {
        ...
        this.outputPort = new KafkaProducerOutput2(bootstrapServers, topic, sensorId, publish);
    }
